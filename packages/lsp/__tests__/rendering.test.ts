...
describe("formatLspCallSummary", () => {
  ...
  it("summary format is compact and echoes only caller-supplied args", () => {
    expect(formatLspCallSummary("pos", { file: "src/a.ts", line: 3, column: 7 })).toBe(
      "src/a.ts:3:7",
    );
    expect(formatLspCallSummary("ref", { file: "src/b.ts", line: 4, column: 8 })).toBe(
      "src/b.ts:4:8",
    );
        ...
        symbols: [
          {
            ...
            kind: "class",
            line: 1,
            children: [{ name: "bar", kind: "function", line: 5 } satisfies LspSymbolRecord],
