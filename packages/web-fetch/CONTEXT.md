...
**Library HTML conversion**: Conversion of fetched HTML into Markdown via the Turndown + jsdom libraries over the capped source; transport stays streamed to disk, conversion memory is bounded by the response cap.
_Avoid_: Streaming HTML extraction, chunked conversion, incremental conversion.
...
- **Library HTML conversion** is the HTML-specific form of **Readable content extraction**, distinct from PDF extraction.
